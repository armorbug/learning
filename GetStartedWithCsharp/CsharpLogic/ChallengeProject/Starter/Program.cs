        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    {
                        //get the pet's age. it must be an integer
                        do
                        {
                    ...
                    {
                        //get the pet's physical description. it cannot be blank 
                        do
                        {
                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == "Nickname: ?")
                    {
                        do
                        {
                            ...
                            //get the pet's nickname. it cannot be blank
                            readResult = Console.ReadLine();
                            if (readResult != null && readResult != "")
                            {
                    ...
                    {
                        //get the pet's personality description. it cannot be blank 
                        do
                        {
